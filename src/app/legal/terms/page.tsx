      ...
      <main className="max-w-5xl mx-auto px-4 md:px-8 py-6">
        <div className="max-w-3xl mx-auto space-y-8 text-sm leading-relaxed text-gray-700">
          <div className="space-y-3">
            ...
            <p>
              この利用規約（以下「本規約」といいます）は、「過去問演習ラボ」（https://kakomon-labo.com、以下「本サービス」といいます）の利用条件を定めるものです。利用者の皆さま（以下「ユーザー」といいます）は、本規約に同意のうえ本サービスをご利用ください。
            </p>
          </div>
          ...
          <section className="space-y-2">
            ...
            <ol className="list-decimal pl-5 space-y-1.5">
              <li>
                本サービスには、無料でご利用いただける「無料会員」と、有料の「プレミアム会員」（月額300円／年額3,000円・いずれも税込）の区分があります。
              </li>
              <li>
          ...
          <section className="space-y-2">
            ...
            <ol className="list-decimal pl-5 space-y-1.5">
              <li>
                プレミアム会員の料金は月額300円または年額3,000円（いずれも税込）とし、決済はStripe, Inc.が提供する決済サービス（クレジットカード決済）により行います。
              </li>
              <li>
